...
public class StorageModule extends AbstractModule {
    ...
    @Provides @Named("warp") @Singleton
    public MongoStorage provideWarpMongoStorage(MongoConnection mongoConnection) {
        return new MongoStorage(mongoConnection.getDatabase().getCollection("warps"));
    }

    @Provides @Named("warp") @Singleton
    public RedisStorage provideWarpRedisStorage(RedisConnection redisConnection) {
        return new RedisStorage(redisConnection, "warp");
    }

    @Provides @Named("pending") @Singleton
