...
public enum DefaultMessageType {
    ...
    ACCEPTED_TPA_REQUEST, // This is a message that indicates that a TPA request has been accepted and the player can start the countdown
    ...
    TELEPORT_REQUEST, // This is a message that requests a teleport to the server that has the player
}
